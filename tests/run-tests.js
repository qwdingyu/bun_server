...
// 所有测试脚本，按执行顺序排列
const testScripts = ['init-db.js', 'test-auth-provider.js', 'test-session-model.js', 'test-auth-session-flow.js', 'test-rbac-priority.js', 'test-user-batch-routes.js', 'test-mysql-schema.js', 'test-config.js', 'test-roles-permissions.js', 'test-users.js', 'test-api.js']
